...
try {
    ...
    $stmt = $pdo->query("SELECT COUNT(*) as count FROM Orders WHERE Status = 'in_progress'");
    $in_progress_count = $stmt->fetch()['count'];
    
    // Всего заявок за все время
    $stmt = $pdo->query("SELECT COUNT(*) as count FROM Orders");
    $total_orders = $stmt->fetch()['count'];
    
    // Последние заявки
    $stmt = $pdo->query("
        SELECT o.ID_order, o.Client, o.Num_phone, o.Status, o.Created_at, 
    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-number"><?= $new_orders_count ?></div>
